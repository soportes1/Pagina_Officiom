...
class Productos extends CI_Model{
  ...
  public function informacion_producto($id){
    $this->db->select('*, producto.id AS pid, producto.imagen AS img, producto.imagen_miniatura as thumb, producto.tipo_empaque AS emp');
    $this->db->from('producto');
    $this->db->join('stock','stock.id_producto=producto.id', 'left');
  ...
  public function resultados_productos($ordenamiento,$where,$inicio,$fin,$marca){
    /////constantes
    $this->db->select('*, producto.id AS pid,producto.imagen AS img, producto.imagen_miniatura AS thumb, producto.descuento, producto.porcentaje_descuento,
     marcas.id AS mid, marcas.imagen AS marcaimg');
    $this->db->from('producto');
    //$this->db->join('stock','stock.id_producto = producto.id');
    $this->db->join('marcas','marcas.id = producto.id_marca');
    ////fin de constantes
