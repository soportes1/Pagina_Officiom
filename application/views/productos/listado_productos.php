           ...
           <div class="items-child">
            ...
            <div style="width:195px; position:relative; margin: 0 auto; font-size:22px;color:#FF0000;" class="text-center">
              <?php
                ...
                if($row->descuento>0){
                  /////monto con descuento
                  $pct_descuento = $row->porcentaje_descuento/100;
                  $monto_descuento = $precio_final * $pct_descuento;
                  $precio_final2 = $precio_final -$monto_descuento;
                  ?>
                    <strike style="font-size:16px; color:#999;">$ <?php echo $precio_final;?></strike><br>
                    <?php echo "$".number_format($precio_final2,2);
                }else{
                    echo "$".$precio_final;
                }
               ?>
